...
notes=true;
  ...
  digiRequest: Wallettopuprequest = new Wallettopuprequest();
  digiResponse: Wallettopupresponse = new Wallettopupresponse();
  digiList: Wallettopupdata[] = [];
  ...
  dataSource = new MatTableDataSource<Wallettopupdata>(this.digiList);
    ...
    if (pager)
 {
  ...
  exportExcel() {
    ...
    XLSX.writeFile(workBook, 'Digital Gold.xlsx');
}
...
startToday=new Date();
  ...
  txndate() {
    ...
    if (this.startDate.dirty && (this.digiRequest.fromDate != null || this.digiRequest.fromDate != "")) {
  ...
  getDigi() {
    ...
    this.digiRequest.fromDate = this.convFromDate;
    this.digiRequest.toDate = this.convToDate;

    if ((this.digiRequest.fromDate == "" || this.digiRequest.fromDate == null) &&
      (this.digiRequest.toDate == "" || this.digiRequest.toDate == null)) {
      ...
      if (this.digiRequest.fromDate == "" || this.digiRequest.fromDate == null)
      ...
      else if (this.digiRequest.toDate == "" || this.digiRequest.toDate == null) {
        ...
        if (this.endDate.status == 'VALID') {
          ...
          this.service.getDigi(this.digiRequest).subscribe(digi => {

            // this.topupResponse = topup;
            this.spinnerService.hide();
            this.digiResponse = digi;

            this.digiResponse.data.forEach(stat => {
            ...
            this.digiList = this.digiResponse.data

            this.dataSource.data = this.digiList

            if ((this.digiResponse.status == 'true') && (this.digiList.length != 0)) {
              this.dataSource.data = [];
              this.filter.reset();
            ...
            } else if ((this.digiList.length == 0) && (this.digiResponse.status == 'true')) {
            ...
            else if (this.digiResponse.status == 'false') {
